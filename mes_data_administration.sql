...
CREATE TABLE `t_basic_position`  (
  ...
  `equip_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '设备编码（外键，关联设备信息表 t_equip_info）',
  `material_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '物料编码（外键，关联物料信息表 t_material）',
  `area` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '区域（如设备上的物理区域划分）',
  `position` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '点位（SMT 产线设备的具体物料放置点位）',
  ...
  INDEX `fk_t_basic_position_material`(`material_code`) USING BTREE,
  INDEX `idx_t_basic_position_equip`(`equip_code`) USING BTREE COMMENT '按设备编码查询点位索引',
  INDEX `idx_t_basic_position_equip_material`(`equip_code`, `material_code`) USING BTREE COMMENT '设备 + 物料联合查询点位索引',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'SMT 产线专用，存储设备点位与物料对应关系（文档定义）' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_department`  (
  ...
  `dept_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '部门编码（唯一）',
  `dept_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '部门名称',
  `parent_dept_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'ROOT' COMMENT '上级部门编码，ROOT表示无上级',
  `workshop_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属车间编码（关联t_workshop表的code）',
  `is_valid` tinyint NULL DEFAULT 1 COMMENT '是否有效（1=有效，0=无效）',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_dept_code`(`dept_code`) USING BTREE,
  INDEX `idx_workshop_code`(`workshop_code`) USING BTREE,
  INDEX `idx_parent_dept_code`(`parent_dept_code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '部门信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_department
-- ----------------------------
INSERT INTO `t_department` VALUES (1, 'DEPT001', '技术部', 'ROOT', 'WS001', 1, '2025-10-26 16:15:29', '2025-10-26 16:15:29');
INSERT INTO `t_department` VALUES (2, 'DEPT002', '生产部', 'ROOT', 'WS002', 1, '2025-10-26 16:15:29', '2025-10-26 16:15:29');
INSERT INTO `t_department` VALUES (3, 'DEPT003', '质量部', 'ROOT', 'WS003', 1, '2025-10-26 16:15:29', '2025-10-26 16:15:29');
...
CREATE TABLE `t_equip_info`  (
  ...
  INDEX `fk_t_equip_info_workshop`(`workshop_code`) USING BTREE,
  INDEX `idx_t_equip_info_model`(`model_code`) USING BTREE COMMENT '设备型号编码查询索引',
  INDEX `idx_t_equip_info_line_status`(`line_code`, `status`) USING BTREE COMMENT '产线 + 设备状态联合查询索引',
...
CREATE TABLE `t_equip_model`  (
  ...
  INDEX `idx_t_equip_model_name`(`model_name`) USING BTREE COMMENT '设备型号名称查询索引'
...
CREATE TABLE `t_material`  (
  ...
  `sku_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'SKU 编码（外键）',
  ...
  INDEX `fk_t_material_moisture`(`moisture_level_code`) USING BTREE,
  INDEX `fk_t_material_shelf_life`(`shelf_life_code`) USING BTREE,
  INDEX `fk_t_material_warehouse`(`warehouse_code`) USING BTREE,
  INDEX `idx_t_material_sku`(`sku_code`) USING BTREE COMMENT 'SKU 编码查询索引',
  INDEX `idx_t_material_name_spec`(`material_name`, `spec`) USING BTREE COMMENT '物料名称 + 规格联合查询索引',
...
-- ----------------------------
INSERT INTO `t_material` VALUES ('33004070001', 'sku 物料', '', 'sku001', 'lyz02', '111', 'ck01');
INSERT INTO `t_material` VALUES ('33004070002', '原材料 2', '', 'sku001', 'lyz02', '111', 'ck01');
INSERT INTO `t_material` VALUES ('33004070003', '原材料 3', '', 'sku001', 'lyz02', '111', 'ck01');
...
CREATE TABLE `t_material_sku`  (
  `sku_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'SKU 编码（主键）',
  `sku_desc` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'SKU 描述',
  `is_valid` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '是否有效（Y/N）',
  PRIMARY KEY (`sku_code`) USING BTREE,
  INDEX `idx_t_material_sku_desc`(`sku_desc`) USING BTREE COMMENT 'SKU 描述查询索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '物料 SKU 定义表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_material_sku
-- ----------------------------
INSERT INTO `t_material_sku` VALUES ('sku0001', 'S 码衣服', 'Y');
...
INSERT INTO `t_material_sku` VALUES ('sku005', 'LED 灯', 'Y');
INSERT INTO `t_material_sku` VALUES ('sku006', 'LED 灯', 'Y');
INSERT INTO `t_material_sku` VALUES ('sku007', 'LED 灯', 'Y');
...
CREATE TABLE `t_moisture_level`  (
  ...
  INDEX `idx_t_moisture_level_name`(`moisture_level_name`) USING BTREE COMMENT '湿敏级别名称查询索引'
...
-- ----------------------------
INSERT INTO `t_moisture_level` VALUES ('lyz02', '8 级别', 'Y');
...
CREATE TABLE `t_process`  (
  ...
  INDEX `idx_t_process_section`(`section_code`) USING BTREE COMMENT '工艺段编码查询索引',
  INDEX `idx_t_process_section_collection`(`section_code`, `is_collection`) USING BTREE COMMENT '工艺段 + 是否采集联合查询索引',
...
INSERT INTO `t_process` VALUES ('lyzgx002', '通用 QC（局胜制）', 'gyd001', 0, 'Y', 'Y');
INSERT INTO `t_process` VALUES ('lyzgx012', '通用 QC（抽测工序）', 'gyd001', 0, 'Y', 'Y');
...
CREATE TABLE `t_process_section`  (
  ...
  `section_category` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '工艺段类别（通用类 / SMT 类）',
  ...
  INDEX `idx_t_process_section_category`(`section_category`) USING BTREE COMMENT '工艺段类别查询索引',
  INDEX `idx_t_process_section_resource`(`resource_type`) USING BTREE COMMENT '资源类型查询索引'
...
INSERT INTO `t_process_section` VALUES ('gyd002', 'SMT 类', 'SMT 类', '流水线', 'Y');
INSERT INTO `t_process_section` VALUES ('gyd003', '非 IMS 类', '非 IMS 类', '流水线', 'Y');
...
CREATE TABLE `t_prod_proc_material`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_t_prod_proc_mat_material`(`material_code`) USING BTREE,
  INDEX `idx_t_prod_proc_mat_product_process`(`product_code`, `process_code`) USING BTREE COMMENT '产品 + 工序联合查询索引',
  INDEX `idx_t_prod_proc_mat_process_material`(`process_code`, `material_code`) USING BTREE COMMENT '工序 + 物料联合查询索引',
...
CREATE TABLE `t_prod_proc_param`  (
  ...
  `pass_rate_limit` decimal(5, 2) NOT NULL COMMENT '合格率下限（如 99.50）',
  ...
  INDEX `fk_t_prod_proc_param_process`(`process_code`) USING BTREE,
  INDEX `idx_t_prod_proc_param_product_process`(`product_code`, `process_code`) USING BTREE COMMENT '产品 + 工序联合查询索引',
...
CREATE TABLE `t_product`  (
  ...
  INDEX `idx_t_product_name`(`product_name`) USING BTREE COMMENT '产品名称查询索引'
...
CREATE TABLE `t_product_bom`  (
  `bom_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'BOM 编码（主键）',
  `product_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '产品编码（外键）',
  `material_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '物料编码（外键）',
  `qty` decimal(10, 2) NOT NULL COMMENT '物料用量',
  `level` int NOT NULL COMMENT 'BOM 层级（1 = 成品 / 2 = 半成品 / 3 = 原材料）',
  `is_substitute` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '是否替代物料（Y/N）',
  `bom_version` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'BOM 版本',
  PRIMARY KEY (`bom_code`) USING BTREE,
  INDEX `idx_t_product_bom_product_level`(`product_code`, `level`) USING BTREE COMMENT '产品 + 层级联合查询索引',
  INDEX `idx_t_product_bom_material`(`material_code`) USING BTREE COMMENT '物料编码查询索引',
...
CREATE TABLE `t_production_line`  (
  ...
  `line_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '产线名称（如 “lyzcx002（SMT 产线）”）',
  `workshop_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '车间编码（外键）',
  `process_section_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '工艺段编码（外键，关联 t_process_section）',
  ...
  INDEX `idx_t_prod_line_workshop`(`workshop_code`) USING BTREE COMMENT '车间编码查询索引',
  INDEX `idx_t_prod_line_workshop_type`(`workshop_code`, `line_type`) USING BTREE COMMENT '车间 + 产线类型联合查询索引',
...
INSERT INTO `t_production_line` VALUES ('lyzcx002', 'SMT 产线', 'lyzcj002', 'gyd002', 'SMT', 'Y');
INSERT INTO `t_production_line` VALUES ('lyzcx003', '通用产线 1', 'lyzcj001', 'gyd001', '通用', 'Y');
INSERT INTO `t_production_line` VALUES ('lyzcx004', 'SMT 产线 4', 'lyzcj002', 'gyd002', 'SMT', 'Y');
...
CREATE TABLE `t_shelf_life`  (
  ...
  INDEX `idx_t_shelf_life_days`(`days`) USING BTREE COMMENT '保质期天数查询索引'
...
-- ----------------------------
INSERT INTO `t_shelf_life` VALUES ('111', '1 天', 20, 'Y');
...
CREATE TABLE `t_spare_info`  (
  ...
  INDEX `fk_t_spare_info_warehouse`(`warehouse_code`) USING BTREE,
  INDEX `fk_t_spare_info_loc`(`loc_code`) USING BTREE,
  INDEX `idx_t_spare_info_model`(`spare_model_code`) USING BTREE COMMENT '备件型号编码查询索引',
  INDEX `idx_t_spare_info_use_count`(`use_count`) USING BTREE COMMENT '使用次数查询索引',
...
CREATE TABLE `t_spare_model`  (
  ...
  INDEX `idx_t_spare_model_category`(`spare_category`) USING BTREE COMMENT '备件类别查询索引'
...
CREATE TABLE `t_storage_loc`  (
  ...
  INDEX `idx_t_storage_loc_warehouse`(`warehouse_code`) USING BTREE COMMENT '仓库编码查询索引',
  INDEX `idx_t_storage_loc_warehouse_area`(`warehouse_code`, `area_code`) USING BTREE COMMENT '仓库 + 区域联合查询索引',
...
CREATE TABLE `t_tool_info`  (
  ...
  INDEX `fk_t_tool_info_loc`(`loc_code`) USING BTREE,
  INDEX `idx_t_tool_info_model`(`tool_model_code`) USING BTREE COMMENT '工装型号编码查询索引',
  INDEX `idx_t_tool_info_warehouse_loc`(`warehouse_code`, `loc_code`) USING BTREE COMMENT '仓库 + 储位联合查询索引',
...
CREATE TABLE `t_tool_model`  (
  ...
  INDEX `idx_t_tool_model_category`(`tool_category`) USING BTREE COMMENT '工装类别查询索引'
...
INSERT INTO `t_tool_model` VALUES ('lyzgz002', '模治具 2', '模治具', 0, 'N');
...
CREATE TABLE `t_warehouse`  (
  ...
  INDEX `idx_t_warehouse_name`(`warehouse_name`) USING BTREE COMMENT '仓库名称查询索引',
  INDEX `idx_t_warehouse_type`(`warehouse_type`) USING BTREE COMMENT '仓库类型查询索引'
...
CREATE TABLE `t_workshop`  (
  ...
  `workshop_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '车间名称（如 “A 车间（通用类）”）',
  `is_valid` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '是否有效（Y/N）',
  PRIMARY KEY (`workshop_code`) USING BTREE,
  INDEX `idx_t_workshop_name`(`workshop_name`) USING BTREE COMMENT '车间名称查询索引'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '车间基础信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_workshop
-- ----------------------------
INSERT INTO `t_workshop` VALUES ('lyzcj001', 'A 车间（通用类）', 'Y');
INSERT INTO `t_workshop` VALUES ('lyzcj002', 'B 车间（SMT 类）', 'Y');
